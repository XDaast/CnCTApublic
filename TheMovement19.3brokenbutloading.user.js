// ==UserScript==
// @name           Tiberium Alliances The Movement 19.3 broken but loading
// @version        1.0.3.2
           ...
           // Entrypoint RegionMenu
            ...
            qx.Class.define('TheMovement.Hash', {
				...
				construct: function() {
                    ...
                    console.log("TheMovement: ", hashEncoderClassname); //AIKFWS, ?BHYSUC? 19.2 || QPCQBD 19.3
                    ...
                    //console.log("TheMovement: ", this.hashTable); // array
				},
				members: {
					hashTable: null,
            ...
            qx.Class.define('TheMovement.WorldObjectWrapper', {
				...
				construct: function() {
                    ...
                    this.territoryRadiusMemberNameMap[ClientLib.Data.WorldSector.ObjectType.Ruin] = ClientLib.Data.WorldSector.WorldObjectRuin.prototype.$ctor.toString().match(/this\.([A-Z]{6})=\(\(g>>9/)[1];
                    console.log("TheMovement: ", this.territoryRadiusMemberNameMap[ClientLib.Data.WorldSector.ObjectType.City]); // SZCBUY 19.2 || 19.3 LLYWQO
                    console.log("TheMovement: ", this.territoryRadiusMemberNameMap[ClientLib.Data.WorldSector.ObjectType.NPCBase]); // SLYVIK || 19.3 EAXJOP
                    console.log("TheMovement: ", this.territoryRadiusMemberNameMap[ClientLib.Data.WorldSector.ObjectType.Ruin]); //EWWPKY || CPRBJI
                    ...
                    //this.playerDataIndexMemberNameMap[ClientLib.Data.WorldSector.ObjectType.City] = ClientLib.Data.WorldSector.prototype.SetDetails.toString().match(/([A-Za-z]+)=this\.[A-Z]{6}\.d\[[A-Za-z]+\.([A-Z]{6})\];if\(\1!==null\)/)[2];
...
/*
                    ...
                    //console.log("TheMovement: ", this.worldSectorObjectsMemberName);
                    //console.log("TheMovement: ", this.worldSectorPlayersMemberName);
...
*/
			...
			qx.Class.define('TheMovement.RegionManipulator', {
				...
				construct: function(worldObjectWrapper) {
                    ...
                    console.log("TheMovement: ", this.regionSectorsMemberName);
